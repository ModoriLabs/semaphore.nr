...
interface ISemaphoreHonk {
    ...
    function validateProof(uint256 groupId, SemaphoreHonkProof calldata proof) external;

    /// @dev Verifies a zero-knowledge proof by returning true or false.
    /// @param groupId: Id of the group.
    /// @param proof: Semaphore zero-knowledge proof.
    function verifyProof(uint256 groupId, SemaphoreHonkProof calldata proof) external view returns (bool);
}
